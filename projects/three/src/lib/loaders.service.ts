...
import { BufferGeometryLoader, Light, Material, Mesh, MeshStandardMaterial, Object3D, RepeatWrapping, SRGBColorSpace, Scene, TextureLoader, UnsignedByteType, Vector2 } from 'three';
